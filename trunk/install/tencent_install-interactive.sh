...
#	judge.conf 
#	hhxyoj-read-only/web/include/db_info.inc.php
#	and down here
...
then 
bash change_to_archive_source.sh
sudo apt-get update 
sudo apt-get install g++ clang
bash change_to_tencent_source.sh
sudo apt-get update 
sudo apt-get install make flex libmysql++-dev php5 nginx php5-fpm mysql-server php5-mysql php5-gd php5-cli mono-gmcs subversion
...
sed $SED_CMD hhxyoj-read-only/web/include/db_info.inc.php|sed $SED_CMD2 >$WEBBASE/JudgeOnline/include/db_info.inc.php
